...
constexpr KeyNameEntry kKeyNames[] = {
    ...
    {"1", KeyCode::DIGIT_1}, {"2", KeyCode::DIGIT_2},
    {"3", KeyCode::DIGIT_3}, {"4", KeyCode::DIGIT_4},
    {"5", KeyCode::DIGIT_5}, {"6", KeyCode::DIGIT_6},
    {"7", KeyCode::DIGIT_7}, {"8", KeyCode::DIGIT_8},
    {"9", KeyCode::DIGIT_9}, {"0", KeyCode::DIGIT_0},
    {"ENTER", KeyCode::ENTER}, {"ESC", KeyCode::ESC},
    {"BACKSPACE", KeyCode::BACKSPACE}, {"TAB", KeyCode::TAB},
    {"SPACE", KeyCode::SPACE}, {"MINUS", KeyCode::MINUS},
    {"EQUAL", KeyCode::EQUAL}, {"LEFT_BRACKET", KeyCode::LEFT_BRACKET},
    {"RIGHT_BRACKET", KeyCode::RIGHT_BRACKET},
    {"BACKSLASH", KeyCode::BACKSLASH}, {"NON_US_HASH", KeyCode::NON_US_HASH},
    {"SEMICOLON", KeyCode::SEMICOLON}, {"APOSTROPHE", KeyCode::APOSTROPHE},
    {"GRAVE", KeyCode::GRAVE}, {"COMMA", KeyCode::COMMA},
    {"DOT", KeyCode::DOT}, {"SLASH", KeyCode::SLASH},
    ...
    {"SCROLL_LOCK", KeyCode::SCROLL_LOCK}, {"PAUSE", KeyCode::PAUSE},
    {"INSERT", KeyCode::INSERT}, {"HOME", KeyCode::HOME},
    {"PAGE_UP", KeyCode::PAGE_UP}, {"DELETE", KeyCode::DELETE},
    {"END", KeyCode::END}, {"PAGE_DOWN", KeyCode::PAGE_DOWN},
    ...
    {"KEYPAD_1", KeyCode::KEYPAD_1}, {"KEYPAD_2", KeyCode::KEYPAD_2},
    {"KEYPAD_3", KeyCode::KEYPAD_3}, {"KEYPAD_4", KeyCode::KEYPAD_4},
    {"KEYPAD_5", KeyCode::KEYPAD_5}, {"KEYPAD_6", KeyCode::KEYPAD_6},
    {"KEYPAD_7", KeyCode::KEYPAD_7}, {"KEYPAD_8", KeyCode::KEYPAD_8},
    {"KEYPAD_9", KeyCode::KEYPAD_9}, {"KEYPAD_0", KeyCode::KEYPAD_0},
    {"KEYPAD_DOT", KeyCode::KEYPAD_DOT},
    {"LEFT_CTRL", KeyCode::LEFT_CTRL}, {"LEFT_SHIFT", KeyCode::LEFT_SHIFT},
    ...
    {"CTRL", KeyCode::LEFT_CTRL}, {"CONTROL", KeyCode::LEFT_CTRL},
    {"SHIFT", KeyCode::LEFT_SHIFT}, {"ALT", KeyCode::LEFT_ALT},
    {"GUI", KeyCode::LEFT_GUI}, {"CMD", KeyCode::LEFT_GUI},
    {"WIN", KeyCode::LEFT_GUI}, {"WINDOWS", KeyCode::LEFT_GUI},
};
